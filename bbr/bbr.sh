...
wget --no-check-certificate -qO "/lib/modules/$(uname -r)/kernel/net/ipv4/tcp_bbr.ko" "https://raw.githubusercontent.com/MoeClub/apt/master/bbr/ko/${ver}/${arch}/tcp_bbr.ko"
