...
# Aria2c
```
./aria2c --no-conf true --continue=true --file-allocation=falloc --disable-ipv6=true --enable-rpc=false --summary-interval=0 --split=65535 --min-split-size=8M --piece-length=16M --max-connection-per-server=16 -d <DIR> -o <FILE> "<URL>" 
